        ...
        <Row className="align-items-center mb-5">
          ...
          <Col md={8} data-aos="fade-left" className="text-center text-md-start">
            <h2 className="fw-bold text-primary mb-3">
              <FaHelmetSafety className="me-2" />Layanan Cuci Helm
            </h2>
            <p className="text-secondary fs-5 mb-4">
              Helm Anda bau, kotor, atau terasa lembap? Kami bantu bersihkan menyeluruh bagian luar dan dalam dengan cairan khusus antibakteri & antijamur. Hasil wangi, segar, dan aman digunakan kembali.
            </p>
